...
protected:
    void SetUp() override {
        index_ = std::make_unique<HNSWIndex>(2, 4, 16, 1.0f, HNSWIndex::DistanceMetric::L2, 4);
    }
...
TEST_F(HNSWIndexTest, SuccessSearchCosine) {
    index_ = std::make_unique<HNSWIndex>(2, 4, 16, 1.0f, HNSWIndex::DistanceMetric::Cosine, 4);
